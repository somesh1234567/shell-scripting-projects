...
# Purpose: This script will create a ec2 instance using bash and aws CLI
#########################
...
install_awscli() {
    echo "Installing AWS CLI v2 on Machine......."
...
main() {
    ...
    INSTANCE_NAME="EC2 Machine"

    # Call the function to create the EC2 instance
    create_ec2_instance "$AMI_ID" "$INSTANCE_TYPE" "$INSTANCE_NAME"
